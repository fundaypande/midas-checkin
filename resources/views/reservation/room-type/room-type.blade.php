...
@section('description')
    <div class="section-body">
        ...
        <p class="section-lead">
            Seluruh data Room Type tersedia disini
        </p>
    </div>
        ...
        <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Room Type</h4>
                    <div class="text-right"><a onclick="openModalAdd()" id="btn_add_id" class="btn btn-success nde-white nde-pointer">Tambah Room Type</a></div>
                  </div>
                  <div class="card-body">
