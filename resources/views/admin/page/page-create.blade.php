...
@section('breadcrumb')
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="{{ route('page.show') }}">Pages</a></div>
        <div class="breadcrumb-item">Create Page</div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <textarea value="" name="meta_desc" id="meta-desc-id" class="form-control" style="height: 80px;">{{ $post->meta_desc }}</textarea>
                        </div>
...
@section('script')
    ...
    <script>
        ...
        function publish() {
          ...
          request = $.ajax({
              url: "{{ url('/manage/page/publish') }}/"+ {{ $id }},
              type: "post",
              data: serializedData
          });
