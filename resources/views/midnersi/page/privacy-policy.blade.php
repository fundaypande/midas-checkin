...
@section('content')
    ...
    <div style=" padding: 20px; min-height: 100vh;  height: 100%; width: 100%;  background-color: white; margin: 0 auto;">
        ...
        <div id="persiapan_id">
            ...
            <p>Your privacy is important to us. It is Midnersi's policy to respect your privacy regarding any information we may collect from you through our app, Midnersi.</p>
            ...
            <p>This policy is effective as of 21 October 2020.</p>
