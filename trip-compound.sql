...
--
-- Host: localhost
-- Generation Time: Mar 02, 2020 at 01:54 AM
...
CREATE TABLE `price_mapings` (
  `price_maing_id` bigint(20) UNSIGNED NOT NULL,
  `speed_boat_id` bigint(20) UNSIGNED DEFAULT NULL,
  `activity_id` bigint(20) UNSIGNED DEFAULT NULL,
  `rute_type` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'oneway or return',
  `adult_price` decimal(12,2) NOT NULL,
  `children_price` decimal(12,2) NOT NULL,
...
--
-- Dumping data for table `price_mapings`
--

INSERT INTO `price_mapings` (`price_maing_id`, `speed_boat_id`, `activity_id`, `rute_type`, `adult_price`, `children_price`, `description`, `created_at`, `updated_at`) VALUES
(1, 1, NULL, 'one way', '27.00', '16.00', '', NULL, NULL),
(4, 1, NULL, 'return', '39.50', '27.00', '', NULL, NULL),
(5, 2, NULL, 'return', '54.00', '36.00', '', NULL, NULL),
(6, 2, NULL, 'one way', '36.00', '23.50', '', NULL, NULL);
...
ALTER TABLE `price_mapings`
  ADD PRIMARY KEY (`price_maing_id`),
  ADD KEY `speed_boat_id` (`speed_boat_id`),
...
--
ALTER TABLE `price_mapings`
  MODIFY `price_maing_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Constraints for table `price_mapings`
--
ALTER TABLE `price_mapings`
  ADD CONSTRAINT `price_mapings_ibfk_1` FOREIGN KEY (`speed_boat_id`) REFERENCES `speed_boats` (`speed_boat_id`);
